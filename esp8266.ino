...
// I refer from github page - https://github.com/roboremo/ESP8266-WiFi-UART-Bridge
// And it worked when I tested with telnet 
...
IPAddress ip(192, 168, 1, 112); // From RoboRemo app, connect to this IP
